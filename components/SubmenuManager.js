...
export default function SubmenuManager() {
	...
	return (
		<div className="flex justify-center shadow-2xl bg-slate-700 " role="group">
			<div className="bg-slate-700 text-center md:my-2 my-1 rounded-xl">
				<Link
					href="/manager"
					type="button"
					className={
						(path == "/manager" ? "bg-green-700 " : "bg-gray-700 ") +
				...
				>
					{" "}
					<img src="/icons/upload.svg" alt="" className="w-5 pr-1  h-4"></img>
					Frequency Lists
				</Link>
				<Link
				...
				>
					<svg
						aria-hidden="true"
						className="mr-2 md:w-0 hidden md:block h-4 fill-current"
						fill="currentColor"
						viewBox="0 0 20 20"
						xmlns="http://www.w3.org/2000/svg"
					></svg>
